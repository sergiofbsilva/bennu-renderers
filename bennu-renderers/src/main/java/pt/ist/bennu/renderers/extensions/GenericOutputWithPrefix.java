        ...
        return new Layout() {
            ...
            public HtmlComponent createComponent(Object object, Class type) {
                ...
                HtmlComponent component =
                        possiblyNonEmptyPresentationObject(object) ? RenderKit.getInstance().render(context, object, type) : new HtmlText(
                                RenderUtils.getResourceString(getEmptyBundle(), getEmptyKey()), false);

                HtmlText text =
                        new HtmlText((getPrefixBundle() != null) ? RenderUtils.getResourceString(getPrefixBundle(),
