...
import pt.ist.bennu.renderers.core.components.HtmlStyle;
 ...
 * 
 * <p>
 * The <tt>TreeRenderer</tt> also offers the possibility to include images in each items and make the tree draggable using
 * javascript. If you need a draggable tree then you must choose a {@link #setTreeId(String) treeId} and a
 * {@link #setFieldId(String) fieldId} or a{@link #setSaveUrl(String) saveUrl}.
 * 
 * <p>
 * You can also configure the style and class of several elements in the tree. You must give special attention to the class you
 * choose for the list items because when the tree is draggable those classes have a special meaning.
 * 
 * <p>
 * Example:
 * <ul>
...
public class TreeRenderer extends OutputRenderer {
    ...
    private final Map<String, String> noChildrenMap;
    ...
    private final Map<String, String> hiddenLinksMap;
    private final Map<String, String> imagesMap;
     ...
     * 
     * <p>
     * Note that the form containing the field will be automatically submitted. So you can have a form somewere in the page that
     * looks like:
     * 
     * <pre>
     ...
     * 
     * <p>
     * <strong>Note:</strong> if the tree is draggable this class has a special meaning. If you don't specify images for the items
     * this property will be used to determine the image that will be used for the item. Currently only the "folder" and "sheet"
     * classes are supported. So, you you specify the list item class it's also a good idea to override the image for each item.
     * 
