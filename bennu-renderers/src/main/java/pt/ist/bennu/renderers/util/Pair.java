...
/**
 * A pair is simple aggregation of two values. This class can be used to keep two values together, like a key and value, without
 * depending in any particular data structure.
 * 
